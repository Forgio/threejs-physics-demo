...
gui.add(debugObject, 'createText').name('Create Letter')
...
// Letter
// const letterGeometry = new THREE.BoxBufferGeometry(1, 1, 1)
...
const createText = (position) =>
{

    fontLoader.load(
        '/fonts/comicsans.typeface.json',
        (font) =>
        {
            fontLoader.load(
                '/fonts/comicsans.typeface.json',
    ...
    //   mesh.scale.set(width, height, depth)
       ...
       // Cannon.js body
       const shape = new CANNON.Box(new CANNON.Vec3(0.5, 0.3, 0.2))
